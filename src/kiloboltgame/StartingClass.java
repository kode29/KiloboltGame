...
public class StartingClass extends Applet implements Runnable, KeyListener {
	...
	private static Robot robot; // "static" allows it to be accessed by outside
								// classes
	public static Heliboy hb, hb2;
	public static int score = 0;
	private Font font = new Font(null, Font.BOLD, 30);
	private Image image, character, character2, character3, background,
			characterDown, characterJumped, currentSprite, heliboy, heliboy2,
	...
	private void loadMap(String filename) throws IOException {
		...
		while (true) {
			String line = reader.readLine(); // Equivalent to
												// "foreach ($line as $l){ }";
	...
	public void paint(Graphics g) {
		if (state == GameState.Running) {
			// Important for drawing the character ABOVE the background
			...
			// Collision rectangles - only necessary to outline
